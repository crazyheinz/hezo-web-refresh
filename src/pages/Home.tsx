        ...
        <div className="container mx-auto">
          <div className="grid xl:grid-cols-2 gap-8 xl:gap-10 items-start max-w-7xl mx-auto">
            ...
            <div className="relative">
              <img src={homeNursingImage} alt="Thuisverpleging - professionele zorg aan huis" className="rounded-lg shadow-2xl w-full h-auto object-contain" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              const colorSchemes = [{
                ...
                iconColor: "text-light-blue-foreground",
                ...
                iconBg: "bg-yellow",
                iconColor: "text-yellow-foreground",
                border: "hover:border-yellow/50"
              }, {
                iconBg: "bg-green",
                iconColor: "text-green-foreground",
